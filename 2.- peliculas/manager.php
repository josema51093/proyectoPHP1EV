<?php
	...
	//Comprobamos que hemos pulsado actualizar o eliminar
	...
	//Comprobamos que hemos recibido los datos del formulario de insertar pelicula
	if (isset($_POST['insertar'])) {
		$pelicula = new Pelicula(1,$_POST['titulo'], $_POST['genero'], $_POST['director'], $_POST['year'], $_POST['sinopsis'], subir());
